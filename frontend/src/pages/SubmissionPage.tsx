  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-8 py-8">
        <h1 className="text-3xl font-bold text-center mb-12">과제 제출</h1>
        <div className="max-w-2xl mx-auto px-4">
          <div className="space-y-16"> {/* form을 div로 변경하고 space-y-16 사용 */}
            <form onSubmit={handleSubmit} className="space-y-24"> {/* gap-16을 space-y-24로 변경 */}
              {/* 요구사항 문서 업로드 */}
              <div className="mb-8"> {/* 추가 여백 */}
                <div
                  className={`
              ...
              {/* 제출 버튼 */}
              <div className="flex justify-center items-center w-full mt-16"> {/* mt-8에서 mt-16으로 변경 */}
                <button
                  type="submit"
